...
with open(f'{classname}/{prefix}_cockatrice_set.json', 'r') as json_file:
...
def create_card_image(data):
    ...
    card_image_data = Image.open(f"{classname}/{prefix}_art/{data['name']}.jpg")
...
for card in card_data['card']:
    ...
    card_image.save(f"{classname}/{prefix}_cards/{card['name']}.png")
